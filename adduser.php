...
<head>
    ...
    <title>Add User | Plaridel Integrated National High School</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <form class="needs-validation" action="addnewuser.php" method="POST" novalidate>
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-3">
                            ...
                            <h1 class="h1 mb-0 text-success" style="text-transform:uppercase;"><b>Add User</b></h1>
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <div class="btn-group me-1">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <label for="firstName" class="text-success font-weight-bold">Name</label>
                                        <input type="text" class="form-control form-control-lg" id="name" name="name" placeholder="Name" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="middleName" class="text-success font-weight-bold">Username</label>
                                        <input type="text" class="form-control form-control-lg" id="username" name="username" placeholder="Username" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="lastName" class="text-success font-weight-bold">Password</label>
