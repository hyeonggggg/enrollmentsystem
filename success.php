            ...
            <div class="container px-5">
                ...
                <div class="bg-light rounded-4 py-5 px-4 px-md-05 mb-5">
                    <div class="text-center mb-3">
                        ...
                        <p class="fs-4">Your enrollment has been successfully processed.</p>
                        <p class="fs-4 px-5">Thank you for choosing <strong>Plaridel Integrated National High School</strong> for your education.<br>We look forward to seeing you soon!<br>Please check your enrollment status for any updates.</p>
                    </div>
